...
var CytchwclsfbZX = React.createClass({
    getDefaultProps(){
        return {
            FPZhongxin : null
        }
    ...
    componentDidMount(){
        //发送登录网络请求
        fetch(settings.fwqUrl + "/app/getNewCytchwclsfbZX", {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                ...
                SiteID : this.props.FPZhongxin.SiteID
            })
        })
...
<ScrollView showsHorizontalScrollIndicator = {true} style={{flex: 1}}>
    ...
    getQuery(){
        ...
        netTool.post(settings.fwqUrl +"/app/getNewCytchwclsfbZX",{
            StudyID : Users.Users[0].StudyID,
            SiteID : this.props.FPZhongxin.SiteID,
