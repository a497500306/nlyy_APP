...
var MLUploadPageNumberLish = React.createClass({
    getDefaultProps(){
        return {
            data:null,
            name:'',
    ...
    componentDidMount(){
        ...
        fetch(settings.fwqUrl + "/app/getImagePageNumberListUser", {
            method: 'POST',
            headers: {
...
// 输出组件类
module.exports = MLUploadPageNumberLish;