...
var MLUploadModel = React.createClass({
    ...
    componentDidMount(){
        ...
        fetch(settings.fwqUrl + "/app/getAddImageModeulesListStatistics", {
            method: 'POST',
            headers: {
        ...
        if (this.state.animating == true) {
            return (
                <View style={styles.container}>
                    <MLNavigatorBar title={'模块上传历史'} isBack={true} backFunc={() => {
        ...
        return (
            <TouchableOpacity onPress={()=> {
                ...
                this.props.navigator.push({
                    component: MLUploadModelLish, // 具体路由的版块
                    //传递参数
                    passProps:{
                        name:rowData
                    }
