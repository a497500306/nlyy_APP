...
var MLUploadPageNumber = require('./MLUploadPageNumber');
var researchParameter = require('../../../entity/researchParameter');
var MLUploadModel = require('./MLUploadModel')

var MLUploadHistory = React.createClass({
    getInitialState() {
        var tableData = [];
        //判断用户类别
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <MLNavigatorBar title={'浏览历史图片'} isBack={true} backFunc={() => {
        ...
        if (rowData == "按页码上传") {
            return (
                <TouchableOpacity onPress={()=> {
                    ...
                    this.props.navigator.push({
                        component: MLUploadPageNumber, // 具体路由的版块
                    });
                }}>
            ...
            return (
                <TouchableOpacity onPress={()=> {
                    // 页面的切换
                    this.props.navigator.push({
                        component: MLUploadModel, // 具体路由的版块
                    });
                }}>
                    <MLTableCell title={rowData}/>
                </TouchableOpacity>
...
// 输出组件类
module.exports = MLUploadHistory;